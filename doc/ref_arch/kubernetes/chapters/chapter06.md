...
The following functionalities are recommended for securing the Kubernetes platform;
- Image Signing
...
- Create administrative boundaries between resources using namespace or clusters and avoid using default namespaces.
